#!/usr/bin/env python3
# Copied unchanged in logic from origin/main blueprints/gap-wave2-20260923/watcher-kill-restart-recovery/mcp_client.py (semantic-rag unit);
# build_env() is overridden by socraticode_eval.py to use this unit's disposable Qdrant, temp HOME and collection prefix.
