...
| Measured (repository files) | 1149 trading-origin `x-ratelimit-limit: 200` and 14 data-origin `10000` headers in the retained adaptive-paper trial outputs (419 and 9 before the 2026-09-24 macOS trials `trials/mac-2026-09-24-*` added 730 and 5; the mover trial `mac-2026-09-24-mover-a` accounts for 508 and 1). |
