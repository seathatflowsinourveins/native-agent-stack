...
| Measured (repository files) | 641 trading-origin `x-ratelimit-limit: 200` and 13 data-origin `10000` headers in the retained adaptive-paper trial outputs (419 and 9 before the 2026-09-24 macOS trials `trials/mac-2026-09-24-*` added 222 and 4). |
