...
| Measured (repository files) | 1629 trading-origin `x-ratelimit-limit: 200` and 15 data-origin `10000` headers in the retained adaptive-paper trial outputs (419 and 9 before the 2026-09-24 macOS trials `trials/mac-2026-09-24-*` added 1210 and 6; the mover trials `mac-2026-09-24-mover-a` and `mac-2026-09-24-mover-c` account for 508 and 1, and 480 and 1). |
