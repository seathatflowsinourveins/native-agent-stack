...
class NativeIntegration(unittest.TestCase):
    ...
    def test_uuid_broker_ids_fill_without_trade_id_overflow(self):
        ...
        self.assertTrue(strategy.flat_seen)
        self.assertEqual(port.qty, 0)
        first = ADAPTER.fill_trade_id("7f3c2c7e-0c1d-4f5e-9a39-2d4a7a1c9b10", Decimal("1"))
        self.assertEqual(len(str(first)), 36)
        self.assertEqual(first, ADAPTER.fill_trade_id("7f3c2c7e-0c1d-4f5e-9a39-2d4a7a1c9b10", Decimal("1")))
        self.assertNotEqual(first, ADAPTER.fill_trade_id("7f3c2c7e-0c1d-4f5e-9a39-2d4a7a1c9b10", Decimal("2")))
