...
- No vulnerability threshold policy exists. Grype is report-only, and Trivy is deferred. Update 2026-09-22 (docs/decisions/2026-09-22-github-automation-closure.md): superseded; grype now gates at --fail-on high with a reviewed .grype.yaml, dependency-review fails on high, and OSV-Scanner fails on any unignored vulnerability in every tracked lockfile.
