...
Layers: 20 foundation, 12 trading. Winners: 66 layer-winner pairs (55 distinct components). Pairs accepted end to end: 33 on WSL2, 0 on macOS. Distinct components pinned behind upstream: 12. Pairs a new host still has to prove: 33 on WSL2, 56 on macOS (the `needs_host` lists in `catalogs/landscape/component-evidence-matrix.json`).
...
| Git practice and GitHub automation | retain | `worktrunk` | 0.79.0 | source_review | not_established | host_verified | — | 11 / 12 |
...
| Application and service hosting | retain | `fastapi` | 0.141.1 | native_proven | accepted | host_verified | — | 6 / 14 |
|  |  | `nextjs` | 16.3.5 (behind v16.3.6) | native_proven | accepted | host_verified | — |  |
|  |  | `postgresql` | 18.6 | native_proven | accepted | host_verified | — |  |
...
| Isolation | retain | `worktrunk` | 0.79.0 | native_proven | accepted | host_verified | — | 16 / 19 |
...
|  |  | `playwright-test` | 1.63.0 | local_integration | conditional | host_verified | — |  |
...
| Secrets and credentials | keep_but_compare | `gitleaks` | 8.30.1 | local_integration | conditional | host_verified | — | 5 / 9 |
...
| Context and usage efficiency | keep_but_compare | `rtk` | 0.49.0 | synthetic | conditional, bootstrap 0.49.0 | host_verified | foundation-cpu | 4 / 6 |
...
|  |  | `worktrunk` | 0.79.0 | local_integration | conditional | host_verified | — |  |
...
|  |  | `gitleaks` | v8.30.1 | native_proven | accepted | host_verified | — |  |
