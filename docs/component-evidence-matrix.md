...
| `foundation/semantic-rag` | dual_lane_same_winner | socraticode (host_verified [2/0/1/0] dissented 1 / untested [1/0/0/0]); qdrant (host_verified [3/0/3/0] / untested [1/0/0/0]); vllm (host_verified [3/0/2/0] / untested [0/0/0/0]) |
