...
| `foundation/recovery-portability` | dual_lane_same_winner | restic (host_verified [1/0/1/0] / untested [1/0/0/0]); candidate:astral-sh-uv (conditional [0/0/0/0] / untested [0/0/0/0]) |
| `foundation/scheduling-supervision` | dual_lane_same_winner | dagu (host_verified [1/0/1/0] / untested [0/0/0/0]); systemd (conditional [2/0/1/0] dissented 1 / untested [0/0/0/0]) |
| `foundation/secrets-credentials` | dual_lane_same_winner | gitleaks (host_verified [1/0/1/0] / host_verified [1/0/1/0]) |
| `foundation/semantic-rag` | dual_lane_same_winner | socraticode (accepted [0/0/0/0] / untested [1/0/0/0]); qdrant (host_verified [1/0/1/0] / untested [1/0/0/0]); vllm (host_verified [3/0/2/0] / untested [0/0/0/0]) |
